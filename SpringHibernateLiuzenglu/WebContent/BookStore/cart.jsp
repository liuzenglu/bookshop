    ...
    <div class="left_content">
      ...
      <div class="feat_prod_box_details">
        <table class="cart_table">
          ...
          <c:forEach items="${cartbooklist}" var="cartbooklist">
          <tr>
            <td><a href="${ctx}/book/details.do?book_id=${cartbooklist.book_id}"><img style="width: 60px;height: 80px;"src="../${cartbooklist.book_imgurl}" alt="" title="" border="0" class="cart_thumb" /></a></td>
            <td>${cartbooklist.book_name}</td>
            <td>${cartbooklist.book_price}</td>
            <td>1</td>
          </tr>
          </c:forEach>
        ...
        <a href="${ctx}/book/someBooklist.do" class="continue">&lt; 继续购买</a> <a href="${ctx}/order/addorder.do" class="checkout">确认订单 &gt;</a> </div>
      <div class="clear"></div>
